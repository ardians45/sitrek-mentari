...
(function () {
    ...
    notification.innerHTML = `
      <div class="version-status-content">
        ...
        <div class="update-body">
          <p>Versi terbaru <strong>Asterix Studio v${latestVersion}</strong> sudah tersedia! Pembaruan ini berisi perbaikan bug dan peningkatan performa.</p>
          ${
    ...
    <div class="popup-content">
      <div class="popup-header">
        <div class="header-top">
          <span class="popup-title">ASTERIX STUDIO</span>
  ...
  `;
    ...
    .token-role-badge {
      background: linear-gradient(135deg, rgba(0, 240, 255, 0.15) 0%, rgba(0, 112, 243, 0.15) 100%);
      color: #00f0ff;
      padding: 4px 10px;
      border-radius: 20px;
      font-size: 10px;
    ...
    .popup-title {
      ...
      font-weight: 700;
      letter-spacing: -0.5px;
      background: linear-gradient(90deg, #00f0ff, #0070f3, #00f0ff);
    ...
    .token-tab:hover { color: #f4f4f5; }
    
    .token-tab.active { color: #fff; font-weight: 600; }
    ...
    .token-tab-content::-webkit-scrollbar { width: 5px; }
