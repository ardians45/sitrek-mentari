...
function showPresensiTable(presensiData) {
  ...
  header.innerHTML = `
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap;">
      <h2 style="margin: 0; font-size: 24px; font-weight: 700; color: #fff; letter-spacing:-0.5px;">Ringkasan Presensi</h2>
      <span style="background: linear-gradient(135deg, rgba(0,240,255,0.15) 0%, rgba(0,112,243,0.15) 100%); color: #00f0ff; border: 1px solid rgba(0,240,255,0.2); padding: 6px 14px; border-radius: 20px; font-size: 13px; font-weight: 600; margin-top: 8px;">
        ${presensiData.length} Mata Kuliah
      </span>
    </div>
    
    <div style="display: flex; flex-wrap: wrap; gap: 20px; background: rgba(255,255,255,0.02); padding: 16px 20px; border-radius: 16px; border: 1px solid rgba(255,255,255,0.04);">
      <div style="flex: 1; min-width: 200px;">
        <div style="font-size: 12px; color: #a1a1aa; margin-bottom: 4px; font-weight: 500;">Nama Mahasiswa</div>
        <div style="font-weight: 600; font-size: 15px; color: #f4f4f5;">${mahasiswaInfo.nama_mahasiswa}</div>
      </div>
      <div style="flex: 1; min-width: 100px;">
        <div style="font-size: 12px; color: #a1a1aa; margin-bottom: 4px; font-weight: 500;">NIM</div>
        <div style="font-weight: 600; font-size: 15px; color: #f4f4f5;">${mahasiswaInfo.nim}</div>
      </div>
      <div style="flex: 1; min-width: 200px;">
        <div style="font-size: 12px; color: #a1a1aa; margin-bottom: 4px; font-weight: 500;">Semester</div>
        <div style="font-weight: 600; font-size: 15px; color: #f4f4f5;">${mahasiswaInfo.nama_semester_registrasi}</div>
      </div>
    </div>
  `;
  ...
  table.innerHTML = `
    <thead>
      <tr style="background: rgba(255,255,255,0.03); text-transform: uppercase; font-size: 12px; letter-spacing: 0.5px;">
        <th style="padding: 16px; text-align: left; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.06);">No</th>
        <th style="padding: 16px; text-align: left; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.06);">Mata Kuliah</th>
        <th style="padding: 16px; text-align: center; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.06);">Kode</th>
        <th style="padding: 16px; text-align: center; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.06);">SKS</th>
        <th style="padding: 16px; text-align: center; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.06);">Tot. Pertemuan</th>
        <th style="padding: 16px; text-align: center; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.06);">Hadir</th>
        <th style="padding: 16px; text-align: center; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.06);">Absen</th>
        <th style="padding: 16px; text-align: center; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.06);">P (%)</th>
      </tr>
    </thead>
  ...
  overallStatus.innerHTML = `
    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
      <div style="font-size: 14px; color: #a1a1aa; font-weight: 500;">Status Kehadiran:</div>
      <div style="background: ${statusBackground}; color: ${statusColor}; border: 1px solid ${statusColor}40; padding: 6px 14px; border-radius: 20px; font-weight: 600; font-size: 14px; box-shadow: 0 4px 15px ${statusColor}30;">
  ...
  closeButton.textContent = "Tutup Dashboard";
  ...
  presensiData.forEach((data, index) => {
    ...
    row.innerHTML = `
      <td style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.04);">${
        index + 1
      }</td>
      <td style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.04); font-weight: 600; color: #fff;">${
        data.nama_mata_kuliah
      }</td>
      <td style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.04); text-align: center; color: #a1a1aa;">${
        data.id_mata_kuliah
      }</td>
      <td style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.04); text-align: center; font-weight: 600;">${sks}</td>
      <td style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.04); text-align: center;">${totalPertemuan}</td>
      <td style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.04); text-align: center; color: #34d399; font-weight: 600;">${hadir}</td>
      <td style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.04); text-align: center; color: #fb7185; font-weight: 600;">${
        totalPertemuan - hadir
      }</td>
      <td style="padding: 16px; border-bottom: 1px solid rgba(255,255,255,0.04); text-align: center;">
        <div style="display: inline-flex; align-items: center; gap: 6px; background: ${statusBg}; color: ${statusColor}; border: 1px solid ${statusColor}40; padding: 4px 10px; border-radius: 12px; font-weight: 600; font-size: 13px;">
          ${persentase}%
        </div>
      </td>
    `;
